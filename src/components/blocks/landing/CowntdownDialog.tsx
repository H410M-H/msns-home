...
const CountdownDialog = () => {
  ...
  const endDateRef = useRef<Date>(new Date("2025-09-02T00:00:00"))
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            "ml-4 backdrop-blur-xs bg-white/10 hover:bg-white/20",
      ...
      <DialogContent className="max-w-xs sm:max-w-md md:max-w-2xl xl:max-w-4xl border-0 bg-transparent backdrop-blur-xl">
        <div className="relative rounded-3xl bg-linear-to-br from-blue-500/20 to-green-500/20 p-6 sm:p-8 md:p-12 shadow-2xl">
          ...
          <div className="relative z-10 text-center py-4 sm:py-6 space-y-4 sm:space-y-6">
            ...
            <div className="h-2 sm:h-3 bg-white/10 rounded-full overflow-hidden">
              <div 
                className="h-full bg-linear-to-r from-blue-400 to-purple-400 transition-all duration-1000"
...
const TimeCard = ({ value, label, icon }: { value: number; label: string; icon?: React.ReactNode }) => (
  <div className="p-3 sm:p-4 bg-white/5 backdrop-blur-xs rounded-xl border border-white/10">
    <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-transparent bg-clip-text bg-linear-to-br from-white to-blue-100">
