  ...
  return (
    <div className="space-y-12">
      ...
      >
        ...
        <div className="rounded-2xl border bg-gradient-to-b from-blue-50/50 to-transparent p-6">
        ...
        <motion.div 
          className="rounded-2xl border bg-gradient-to-b from-cyan-50/50 to-transparent p-6"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div 
          className="rounded-2xl border bg-gradient-to-b from-purple-50/50 to-transparent p-6"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
