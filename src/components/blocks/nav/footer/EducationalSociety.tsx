  ...
  return (
    <div className="space-y-4 text-sm leading-relaxed text-slate-700">
      ...
      <ul className="list-disc pl-5 space-y-2">
        ...
        <li>
          <strong>Technological Enablement:</strong> Provisioning essential hardware and subsidized broadband connectivity to guarantee digital equity in modern pedagogy.
        </li>
        <li>
          <strong>Female Educational Empowerment:</strong> Ring-fencing endowment funds specifically to combat female attrition in higher secondary education through targeted financial and psychosocial support.
        </li>
        <li>
          <strong>Vocational Skill Development:</strong> Sponsoring specialized weekend cohorts focusing on financial literacy, advanced coding, and leadership development.
        </li>
      </ul>
    </div>
  );
