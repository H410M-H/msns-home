...
export const MATRIC_TEXTBOOKS: MatricTextbook[] = [
  ...
  },
  {
    ...
    fileSize: "91.0 MB Full PDF (222 Pages)",
  ...
  },
  {
    ...
    medium: "English & Urdu",
    publisher: "Punjab Curriculum and Textbook Board (PCTB)",
    edition: "Complete 112-Page Single National Curriculum (SNC) Edition",
    totalChapters: 4,
    filename: "pctb-class-9-pakistan-studies.pdf",
    fileSize: "32.1 MB Full PDF (112 Pages)",
  ...
  },
  {
    ...
    medium: "Urdu",
    publisher: "Punjab Curriculum and Textbook Board (PCTB)",
    edition: "Complete 113-Page Single National Curriculum (SNC) Edition",
    totalChapters: 6,
    filename: "pctb-class-10-islamiat.pdf",
    fileSize: "34.0 MB Full PDF (113 Pages)",
